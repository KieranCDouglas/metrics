...
# These end up being an absolute difference of 0.1767 and 0.0697 respecitvely. 
```
...
# It looks like the main issue here is that Waugh has transformed green color on the asparagus variable 
...
# signifiacnt at 0.001<p<0.01 level. All of these observations are ceterus parabus. 
```
...
Chow's model: LN_RENT= β0 + β1LN_MEM + β2LN_MULT + β3LN_ACCESS + u My first f-test yielded the following statistics: Chow F-statistic: 0.5574, df = (20, 58), p-value = 0.9256 My second f-test yielded the following statitstics: Chow F-statistic: 0.6243, df = (20, 31), p-value = 0.863723
...
# the alternative hypothesis that these slope coeﬃcients varied from year to year
# run the model
